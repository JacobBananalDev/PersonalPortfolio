...
import logo from '../icons/JB_logo_transparentBg.png'
import { PortfolioHeaderItems } from '../constants/constants';
    ...
    >
      ...
      <nav className="hidden lg:block">
        <div className="cursor-pointer items-center space-x-4 sm:flex sm:flex-col sm:gap-4 lg:flex lg:flex-row lg:gap-6">
          {
            PortfolioHeaderItems.map((index) => (
              <HeaderItem key={index.id} to={index.to} content={index.content} activeSection={activeSection} offset={index.offset}/>
            ))
          }
